export default {
  ...
  "appDesc": {
    "message": "Control Chrome with Verboo — an AI side panel for browser automation"
  },
  "openSidePanel": {
    "message": "Open Verboo side panel"
  },
  "branding_title": {
    "message": "Verboo"
  },
  ...
  "mode_manual_desc": {
    "message": "Review every action before it runs"
  },
  "mode_auto": {
    "message": "Auto"
  },
  "mode_auto_desc": {
    "message": "Fewer prompts; safety checks still apply"
  },
  "mode_skip": {
    "message": "Skip"
  },
  "mode_skip_desc": {
    "message": "No routine prompts; hard blocks still enforced"
  },
  "siteGrants_title": {
    "message": "Site grants"
  },
  "siteGrants_empty": {
    "message": "No site grants yet. Grants appear when you interact with a site."
  },
  ...
  "selection_context_verifying": {
    "message": "Checking the complete selection…"
  },
  "selection_context_incomplete": {
    "message": "Selection may be incomplete."
  },
  "selection_context_remove": {
    "message": "Remove selected text"
  },
